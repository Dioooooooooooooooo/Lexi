...
import { AuthenticationLoginStreaks, AuthenticationSessions } from '../db';
...
export type Session = Selectable<AuthenticationSessions>;
export type LoginStreak = Selectable<AuthenticationLoginStreaks>;
