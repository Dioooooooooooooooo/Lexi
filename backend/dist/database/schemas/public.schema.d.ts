...
import { Achievements, Activities, ActivityLogs, ClassroomEnrollment, Classrooms, Genres, MinigameLogs, Minigames, PupilLeaderboard as PLTable, PupilAchievements, Pupils, ReadingMaterials, ReadingSessions, Teachers } from '../db.d';
export declare enum MinigameType {
    SentenceRearrangement = 0,
    Choices = 1,
    WordsFromLetters = 2
}
