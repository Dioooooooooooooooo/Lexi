...
/**
 * This adds a reading material to the library
 */
export const libraryEntriesControllerCreate = <ThrowOnError extends boolean = false>(options: Options<LibraryEntriesControllerCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<LibraryEntriesControllerCreateResponses, unknown, ThrowOnError>({
...
/**
 * This will get all reading materials in library.
 */
export const libraryEntriesControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<LibraryEntriesControllerFindAllData, ThrowOnError>) => {
    return (options?.client ?? client).get<LibraryEntriesControllerFindAllResponses, unknown, ThrowOnError>({
        url: '/library-entries',
        ...options
    });
};
...
/**
 * Remove reading material from library.
 */
export const libraryEntriesControllerRemove = <ThrowOnError extends boolean = false>(options: Options<LibraryEntriesControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? client).delete<LibraryEntriesControllerRemoveResponses, unknown, ThrowOnError>({
