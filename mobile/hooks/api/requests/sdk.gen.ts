...
export const authControllerCheckUser = <ThrowOnError extends boolean = false>(options: Options<AuthControllerCheckUserData, ThrowOnError>) => {
    return (options.client ?? client).get<AuthControllerCheckUserResponses, AuthControllerCheckUserErrors, ThrowOnError>({
        url: '/auth/check-user',
        ...options
    });
};
