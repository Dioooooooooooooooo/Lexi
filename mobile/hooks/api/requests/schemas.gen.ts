...
export const $EnrollPupilDto = {
    ...
    properties: {
        ...
        pupil_ids: {
            ...
            example: ['a1b40682-1204-48b4-9b5e-309b29ff640a', 'ad8e218c-c1cf-4718-b99d-72af5fafffb9'],
            type: 'array',
            items: {
                type: 'array'
            }
...
export const $CreateChoicesGame = {
    ...
    required: ['reading_material_id', 'part_num', 'question', 'choices', 'explanation']
} as const;
...
export const $CreateSentenceRearrangementGame = {
    ...
    required: ['reading_material_id', 'part_num', 'correct_answer', 'parts', 'explanation']
} as const;
...
export const $CreateReadingMaterialDto = {
    ...
    required: ['is_deped', 'title', 'author', 'description', 'grade_level', 'cover', 'genres', 'content']
} as const;
